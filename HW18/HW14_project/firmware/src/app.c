...
void APP_Initialize(void) {
    ...
    RPB9Rbits.RPB9R = 0b0101; // B9 is OC3 for the rc servo
...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_CHECK_TIMER:
            ...
            // the flag or timer can make the PIC write to the host
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            if (gotRx) {
                ...
                // OC1RS = ((float) abs(rxVal))/100.0*1199.0; // velocity, 50%=600
                // OC4RS = ((float) abs(rxVal))/100.0*1199.0; // velocity, 50%=600
               
                float kp=1.8;
                int MAX_DUTY= 520; // 1199;
                ...
                len = sprintf(dataOut, "COM: %d left: %d right: %d\r\n", rxVal, left, right);
